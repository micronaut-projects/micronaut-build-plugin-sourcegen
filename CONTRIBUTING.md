...
Sign the [Contributor License Agreement (CLA)](https://cla-assistant.io/micronaut-projects/micronaut-build-plugin-sourcegen). This is required before any of your code or pull-requests are accepted.
...
Micronaut build-plugin-sourcegen currently requires JDK 17.

## IDE Setup

Micronaut build-plugin-sourcegen can be imported into IntelliJ IDEA by opening the `build.gradle` file.

## Docker Setup

Micronaut build-plugin-sourcegen tests currently require Docker to be installed.
