...
We have a [template repo](https://github.com/micronaut-projects/micronaut-build-plugin-sourcegen) that we use as the single
...
[Release GitHub Action workflow](https://github.com/micronaut-projects/micronaut-build-plugin-sourcegen/blob/master/.github/workflows/release.yml)
